...
#define OMM_HEALTH_PER_SEGMENT                      ((OMM_HEALTH_MAX - OMM_HEALTH_DEAD) / OMM_HEALTH_NUM_SEGMENTS)
#define OMM_HEALTH_PER_TICK                         (OMM_HEALTH_PER_SEGMENT / OMM_HEALTH_NUM_TICKS_PER_SEGMENT)
#define OMM_HEALTH_NUM_COINS_PER_HEAL               (10)
