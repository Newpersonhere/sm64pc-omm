...
#define OMM_LIGHT(...)                                  gdSPDefLights1(__VA_ARGS__, 0x28, 0x28, 0x28)
...
OMM_TEXT_(BAD_ENDING_TOAD_0,                            "Mario!")
OMM_TEXT_(BAD_ENDING_TOAD_1,                            "The Princess... where is she?")
OMM_TEXT_(BAD_ENDING_TOAD_2,                            "The Grand " Star " didn't free her... Why?")
OMM_TEXT_(BAD_ENDING_TOAD_3,                            "Is there... nothing we can do?")
OMM_TEXT_(BAD_ENDING_TOAD_4,                            "No... we can't give up now!")
OMM_TEXT_(BAD_ENDING_TOAD_5,                            "Yeah! We won't let Bowser win, right?")
OMM_TEXT_(BAD_ENDING_TOAD_6,                            "Mario! We'll help you to save her... again!")
OMM_TEXT_(BAD_ENDING_TOAD_7,                            "Sure! I want to eat her delicious cake!")
OMM_TEXT_(BAD_ENDING_TOAD_8,                            "Come on, Mario! Let's find Princess Peach!")
...
#define OMM_DIALOG_SPARKLY_STAR_1_BOB                   (OMM_DIALOG_START_INDEX + 8)
#define OMM_DIALOG_SPARKLY_STAR_1_WF                    (OMM_DIALOG_START_INDEX + 9)
#define OMM_DIALOG_SPARKLY_STAR_1_JRB                   (OMM_DIALOG_START_INDEX + 10)
#define OMM_DIALOG_SPARKLY_STAR_1_BBH                   (OMM_DIALOG_START_INDEX + 11)
#define OMM_DIALOG_SPARKLY_STAR_1_LLL                   (OMM_DIALOG_START_INDEX + 12)
#define OMM_DIALOG_SPARKLY_STAR_1_SL                    (OMM_DIALOG_START_INDEX + 13)
#define OMM_DIALOG_SPARKLY_STAR_1_THI                   (OMM_DIALOG_START_INDEX + 14)
#define OMM_DIALOG_SPARKLY_STAR_1_TTC                   (OMM_DIALOG_START_INDEX + 15)
#define OMM_DIALOG_SPARKLY_STAR_1_RR                    (OMM_DIALOG_START_INDEX + 16)
#define OMM_DIALOG_SPARKLY_STAR_1_BITDW                 (OMM_DIALOG_START_INDEX + 17)
#define OMM_DIALOG_SPARKLY_STAR_1_BITFS                 (OMM_DIALOG_START_INDEX + 18)
#define OMM_DIALOG_SPARKLY_STAR_1_BITS                  (OMM_DIALOG_START_INDEX + 19)
#define OMM_DIALOG_SPARKLY_STAR_1_TOTWC                 (OMM_DIALOG_START_INDEX + 20)
#define OMM_DIALOG_SPARKLY_STAR_1_VCUTM                 (OMM_DIALOG_START_INDEX + 21)
#define OMM_DIALOG_SPARKLY_STAR_1_COTMC                 (OMM_DIALOG_START_INDEX + 22)
#define OMM_DIALOG_SPARKLY_STAR_1_PSS                   (OMM_DIALOG_START_INDEX + 23)
#define OMM_DIALOG_SPARKLY_STAR_1_WMOTR                 (OMM_DIALOG_START_INDEX + 24)
#define OMM_DIALOG_SPARKLY_STAR_1_SA                    (OMM_DIALOG_START_INDEX + 25)
#define OMM_DIALOG_SPARKLY_STAR_1_GROUNDS               (OMM_DIALOG_START_INDEX + 26)
#define OMM_DIALOG_SPARKLY_STAR_1_INSIDE                (OMM_DIALOG_START_INDEX + 27)
#define OMM_DIALOG_SPARKLY_STAR_1_BASEMENT              (OMM_DIALOG_START_INDEX + 28)
#define OMM_DIALOG_SPARKLY_STAR_1_COURT                 (OMM_DIALOG_START_INDEX + 29)
#define OMM_DIALOG_SPARKLY_STAR_1_BOWSER_4_UNLOCKED     (OMM_DIALOG_START_INDEX + 30)
#define OMM_DIALOG_SPARKLY_STAR_1_BOWSER_4_INTRO        (OMM_DIALOG_START_INDEX + 31)
#define OMM_DIALOG_SPARKLY_STAR_1_BOWSER_4_DEFEAT       (OMM_DIALOG_START_INDEX + 32)

#define OMM_DIALOG_SPARKLY_STAR_2_NAMES                 (OMM_DIALOG_START_INDEX + 33)
#define OMM_DIALOG_SPARKLY_STAR_2_BOB                   (OMM_DIALOG_START_INDEX + 34)
#define OMM_DIALOG_SPARKLY_STAR_2_WF                    (OMM_DIALOG_START_INDEX + 35)
#define OMM_DIALOG_SPARKLY_STAR_2_JRB                   (OMM_DIALOG_START_INDEX + 36)
#define OMM_DIALOG_SPARKLY_STAR_2_BBH                   (OMM_DIALOG_START_INDEX + 37)
#define OMM_DIALOG_SPARKLY_STAR_2_HMC                   (OMM_DIALOG_START_INDEX + 38)
#define OMM_DIALOG_SPARKLY_STAR_2_LLL                   (OMM_DIALOG_START_INDEX + 39)
#define OMM_DIALOG_SPARKLY_STAR_2_SSL                   (OMM_DIALOG_START_INDEX + 40)
#define OMM_DIALOG_SPARKLY_STAR_2_SL                    (OMM_DIALOG_START_INDEX + 41)
#define OMM_DIALOG_SPARKLY_STAR_2_WDW                   (OMM_DIALOG_START_INDEX + 42)
#define OMM_DIALOG_SPARKLY_STAR_2_THI                   (OMM_DIALOG_START_INDEX + 43)
#define OMM_DIALOG_SPARKLY_STAR_2_TTC                   (OMM_DIALOG_START_INDEX + 44)
#define OMM_DIALOG_SPARKLY_STAR_2_RR                    (OMM_DIALOG_START_INDEX + 45)
#define OMM_DIALOG_SPARKLY_STAR_2_BITDW                 (OMM_DIALOG_START_INDEX + 46)
#define OMM_DIALOG_SPARKLY_STAR_2_BITFS                 (OMM_DIALOG_START_INDEX + 47)
#define OMM_DIALOG_SPARKLY_STAR_2_BITS                  (OMM_DIALOG_START_INDEX + 48)
#define OMM_DIALOG_SPARKLY_STAR_2_TOTWC                 (OMM_DIALOG_START_INDEX + 49)
#define OMM_DIALOG_SPARKLY_STAR_2_VCUTM                 (OMM_DIALOG_START_INDEX + 50)
#define OMM_DIALOG_SPARKLY_STAR_2_COTMC                 (OMM_DIALOG_START_INDEX + 51)
#define OMM_DIALOG_SPARKLY_STAR_2_PSS                   (OMM_DIALOG_START_INDEX + 52)
#define OMM_DIALOG_SPARKLY_STAR_2_WMOTR                 (OMM_DIALOG_START_INDEX + 53)
#define OMM_DIALOG_SPARKLY_STAR_2_SA                    (OMM_DIALOG_START_INDEX + 54)
#define OMM_DIALOG_SPARKLY_STAR_2_GROUNDS               (OMM_DIALOG_START_INDEX + 55)
#define OMM_DIALOG_SPARKLY_STAR_2_INSIDE                (OMM_DIALOG_START_INDEX + 56)
#define OMM_DIALOG_SPARKLY_STAR_2_UPSTAIRS              (OMM_DIALOG_START_INDEX + 57)
#define OMM_DIALOG_SPARKLY_STAR_2_COURT                 (OMM_DIALOG_START_INDEX + 58)
#define OMM_DIALOG_SPARKLY_STAR_2_BOWSER_4_UNLOCKED     (OMM_DIALOG_START_INDEX + 59)
#define OMM_DIALOG_SPARKLY_STAR_2_BOWSER_4_INTRO        (OMM_DIALOG_START_INDEX + 60)
#define OMM_DIALOG_SPARKLY_STAR_2_BOWSER_4_DEFEAT       (OMM_DIALOG_START_INDEX + 61)

#define OMM_DIALOG_SPARKLY_STAR_3_NAMES                 (OMM_DIALOG_START_INDEX + 62)
...
#define OMM_TEXTURE_(id, name)                          static const char OMM_TEXTURE_##id[] = OMM_GFX name ".png";
...
OMM_TEXTURE_(PEACH_BODY,                                "peach/omm_texture_peach_body")
OMM_TEXTURE_(PEACH_OPEN,                                "peach/omm_texture_peach_open")
OMM_TEXTURE_(PEACH_HALF,                                "peach/omm_texture_peach_half")
OMM_TEXTURE_(PEACH_CLOSE,                               "peach/omm_texture_peach_close")
OMM_TEXTURE_(PEACH_HURT,                                "peach/omm_texture_peach_hurt")
OMM_TEXTURE_(PEACH_YEAH,                                "peach/omm_texture_peach_yeah")
OMM_TEXTURE_(PEACH_JOY,                                 "peach/omm_texture_peach_joy")
OMM_TEXTURE_(PEACH_RAGE,                                "peach/omm_texture_peach_rage")
OMM_TEXTURE_(PEACH_GLOOM,                               "peach/omm_texture_peach_gloom")
OMM_TEXTURE_(PEACH_WINGS,                               "peach/omm_texture_peach_wings")
OMM_TEXTURE_(PEACH_METAL,                               "peach/omm_texture_peach_metal")
OMM_TEXTURE_(PEACH_TIARA,                               "peach/omm_texture_peach_tiara")
OMM_TEXTURE_(PEACH_TIARA_METAL,                         "peach/omm_texture_peach_tiara_metal")
OMM_TEXTURE_(PEACH_PERRY,                               "peach/omm_texture_peach_perry")
...
#define oCappyYaw                                       OBJECT_FIELD_S16(0x1C, 1)
#define oCappyStartAnim                                 OBJECT_FIELD_S16(0x1D, 0)
#define oCappyInteractMario                             OBJECT_FIELD_S16(0x1D, 1)
#define oCappyHomingAttack                              OBJECT_FIELD_S16(0x1E, 0)
#define oCappyThrowStrength                             OBJECT_FIELD_S16(0x1E, 1)
