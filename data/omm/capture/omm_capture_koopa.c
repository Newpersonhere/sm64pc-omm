...
s32 cappy_koopa_update(struct Object *o) {
    ...
    switch (animData[2]) {
        case 1:
            if (obj_is_on_ground(o)) {
                obj_make_step_sound_and_particle(o, &gOmmData->object->state.walkDistance, omm_capture_get_walk_speed(o) * 8.f, o->oForwardVel, SOUND_OBJ_KOOPA_WALK, OBJ_STEP_PARTICLE_NONE);
            }
            break;
