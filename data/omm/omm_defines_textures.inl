...
OMM_TEXTURE_(EFFECT_PERRY_BLAST,                        "effect/omm_texture_effect_perry_blast")
OMM_TEXTURE_(EFFECT_PERRY_BLAST_RAGE,                   "effect/omm_texture_effect_perry_blast_rage")
OMM_TEXTURE_(EFFECT_PERRY_BLAST_GLOOM,                  "effect/omm_texture_effect_perry_blast_gloom")
OMM_TEXTURE_(EFFECT_PERRY_BLAST_CALM,                   "effect/omm_texture_effect_perry_blast_calm")
OMM_TEXTURE_(EFFECT_PERRY_CHARGE_SPARKLE,               "effect/omm_texture_effect_perry_charge_sparkle")
OMM_TEXTURE_(EFFECT_PERRY_CHARGE_GLOW_0,                "effect/omm_texture_effect_perry_charge_glow_0")
OMM_TEXTURE_(EFFECT_PERRY_CHARGE_GLOW_1,                "effect/omm_texture_effect_perry_charge_glow_1")
OMM_TEXTURE_(EFFECT_PERRY_CHARGE_GLOW_2,                "effect/omm_texture_effect_perry_charge_glow_2")
