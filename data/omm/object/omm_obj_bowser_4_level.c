...
static const Vtx omm_bowser_4_level_vertices[] = {
...
static const Gfx omm_bowser_4_level_triangles[] = {
    gsSPVertex(omm_bowser_4_level_vertices, 16, 0),
    ...
    gsSPVertex(omm_bowser_4_level_vertices + 16, 16, 0),
    ...
    gsSPVertex(omm_bowser_4_level_vertices + 32, 3, 0),
    gsSP1Triangle(0, 1, 2, 0x0),
    gsSPEndDisplayList(),

    gsSPVertex(omm_bowser_4_level_vertices + 35, 16, 0),
    gsSP2Triangles(0, 1, 2, 0x0, 3, 4, 5, 0x0),
    ...
    gsSPVertex(omm_bowser_4_level_vertices + 51, 16, 0),
    ...
    gsSPVertex(omm_bowser_4_level_vertices + 67, 16, 0),
    ...
    gsSPVertex(omm_bowser_4_level_vertices + 83, 12, 0),
    gsSP2Triangles(0, 1, 2, 0x0, 1, 3, 2, 0x0),
    ...
    gsSPVertex(omm_bowser_4_level_vertices + 95, 16, 0),
    gsSP2Triangles(0, 1, 2, 0x0, 3, 4, 5, 0x0),
    ...
    gsSPVertex(omm_bowser_4_level_vertices + 95 + 16, 16, 0),
    gsSP2Triangles(0, 1, 2, 0x0, 3, 1, 0, 0x0),
    ...
    gsSPVertex(omm_bowser_4_level_vertices + 95 + 32, 10, 0),
    gsSP2Triangles(0, 1, 2, 0x0, 1, 3, 4, 0x0),
    gsSP2Triangles(5, 6, 7, 0x0, 6, 8, 9, 0x0),
    gsSPEndDisplayList(),

    gsSPVertex(omm_bowser_4_level_vertices + 95 + 42, 16, 0),
    gsSP2Triangles(0, 1, 2, 0x0, 3, 4, 5, 0x0),
    ...
    gsSPVertex(omm_bowser_4_level_vertices + 95 + 58, 9, 0),
    gsSP2Triangles(0, 1, 2, 0x0, 1, 3, 2, 0x0),
    ...
    gsSPVertex(omm_bowser_4_level_vertices + 95 + 67, 16, 0),
    gsSP2Triangles(0, 1, 2, 0x0, 3, 4, 5, 0x0),
...
static const Gfx omm_bowser_4_level_gfx[] = {
    ...
    gsSPDisplayList(omm_bowser_4_level_triangles + 0),
    gsDPLoadTextureBlock(OMM_TEXTURE_BOWSER_4_1, G_IM_FMT_RGBA, G_IM_SIZ_32b, 32, 32, 0, 0, 0, 0, 0, 0, 0),
    gsSPDisplayList(omm_bowser_4_level_triangles + 16),
...
static const GeoLayout omm_geo_bowser_4_level_main[] = {
    ...
    GEO_OPEN_NODE(),
        ...
        GEO_OPEN_NODE(),
            ...
            GEO_OPEN_NODE(),
                ...
                GEO_OPEN_NODE(),
                    GEO_DISPLAY_LIST(LAYER_OPAQUE, omm_bowser_4_level_gfx),
                    GEO_RENDER_OBJ(),
...
static const GeoLayout omm_geo_bowser_4_level_platform[] = {
    GEO_CULLING_RADIUS(5000),
    GEO_OPEN_NODE(),
        GEO_DISPLAY_LIST(LAYER_OPAQUE, omm_bowser_4_level_gfx + 31),
    GEO_CLOSE_NODE(),
    GEO_END(),
};
...
static const Collision omm_bowser_4_level_collision[] = {
    COL_INIT(),
    COL_VERTEX_INIT(0x8),
...
static void omm_bhv_bowser_4_level_update() {
    gCurrentObject->oGraphNode = omm_geo_get_graph_node(omm_geo_bowser_4_level_platform, true);
}

static const BehaviorScript omm_bhv_bowser_4_level[] = {
    0x00090000,
    0x11010001,
    ...
    0x2D000000,
    0x08000000,
    0x0C000000, (uintptr_t) omm_bhv_bowser_4_level_update,
...
OMM_ROUTINE_UPDATE(omm_bowser_4_level_entry) {
...
const LevelScript omm_bowser_4_level_script[] = {
    AREA(2, omm_geo_bowser_4_level_main),
        JUMP_LINK(script_func_global_13),
        OBJECT(MODEL_NONE, 0, 1307, 0, 0, 180, 0, 0x000A0000, bhvSpinAirborneCircleWarp),
        OBJECT(MODEL_NONE, 0, -922, 0, 0, 90, 0, 0x00000000, omm_bhv_bowser_4_level),
        WARP_NODE(0x0A, LEVEL_GROUNDS, 2, 0x0A, WARP_NO_CHECKPOINT),
        WARP_NODE(0xF1, LEVEL_GROUNDS, 1, 0x03, WARP_NO_CHECKPOINT),
        TERRAIN(omm_bowser_4_level_collision),
