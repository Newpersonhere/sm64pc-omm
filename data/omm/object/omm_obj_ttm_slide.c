...
const GeoLayout omm_geo_ttm_slide[] = {
...
static const Collision omm_ttm_slide_part_1_collision[] = {
...
static const Collision omm_ttm_slide_part_2_collision[] = {
...
static const Collision omm_ttm_slide_part_3_collision[] = {
...
static const Collision omm_ttm_slide_collision[] = {
    COL_JUMP(1),
    COL_JUMP(2),
    COL_JUMP(3),
    COL_INIT(),
...
COL_JUMP_REGISTER_INDEX(1, omm_ttm_slide_part_1_collision);
COL_JUMP_REGISTER_INDEX(2, omm_ttm_slide_part_2_collision);
COL_JUMP_REGISTER_INDEX(3, omm_ttm_slide_part_3_collision);

//
// Objects
//

static const LevelScript omm_ttm_slide_objects[] = {
...
static LevelScript omm_ttm_slide_jump_script[] = {
    JUMP(0),
};

const LevelScript omm_ttm_slide_script[] = {
    AREA(2, omm_geo_ttm_slide),
        ...
        JUMP_LINK(omm_ttm_slide_objects),
        TERRAIN(omm_ttm_slide_collision),
        SET_BACKGROUND_MUSIC(0x0001, SEQ_LEVEL_SLIDE),
        TERRAIN_TYPE(TERRAIN_SLIDE),
    END_AREA(),
    JUMP(omm_ttm_slide_jump_script),
};
...
static s32 omm_ttm_slide_set_jump(u8 type, void *cmd) {
    switch (type) {

        // JUMP_LINK
        case 0x06: {
            return OMM_LEVEL_SCRIPT_NEXT_CMD;
        } break;
        
        // FREE_LEVEL_POOL
        case 0x1E: {
            omm_ttm_slide_jump_script[1] = (uintptr_t) cmd;
...
OMM_AT_STARTUP static void omm_ttm_slide_init() {
    omm_level_parse_script(level_ttm_entry, omm_ttm_slide_set_jump);
}
