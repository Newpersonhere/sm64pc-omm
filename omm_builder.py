...
def usage_info():
    ...
    print("")
    print("Usage: python3 omm_builder.py [version] [speed] [args...]")
    print("")
    print("- version:")
    ...
    print("  -  clear  : Don't build anything, delete OMM patches")
    print("")
    print("- speed:")
    print("  One of the following strings:")
    ...
    print("  -  run      : Don't build anything, run the game if an executable is found")
    print("  -  reset    : Don't build anything, reset the target directory without deleting it")
    print("  -  clear    : Don't build anything, delete the target directory")
    print("")
    print("- args:")
    print("  Any of the following strings:")
    print("  -  DEBUG     : Remove code optimization (development only!)")
    ...
    print("")
    print("Requirements:")
    print("- Make sure you launch this script from an MSYS2 terminal, or any Linux-based terminal.")
    print("- To build any version of OMM, you must provide an original Super Mario 64 US ROM, named 'baserom.us.z64' and place it next to this script.")
    print("- To build any version with custom patches, place your .patch files into a 'patches' directory next to this script.")
    print("- To build any version with Texture packs and Music packs, place your packs .zip archives into a 'res' directory next to this script.")
    print("- To build Super Mario 64 Moonshine, you must extract the mod archive (MOONSHINE_FINALUPDATE.rar) next to this script into a directory named 'moonshine'.")
    print("- To build Super Mario Star Road, you must place the patch file (star_road_release.patch) next to this script and name it 'star_road.patch'.")
    sys.exit(0)
