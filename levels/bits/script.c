...
// Ztar Zanctuary warp pipes
// Used to link both parts of ZZ, now in the same level
#define ZZ_WARP_PIPES(w0, x0, y0, z0, a0, w1, x1, y1, z1, a1) \
OBJECT_WITH_ACTS(22, x0, y0, z0, 0, a0, 0, w1 << 16, bhvWarpPipe, ALL_ACTS), WARP_NODE(w1, 21, 2, w0, 0), \
OBJECT_WITH_ACTS(22, x1, y1, z1, 0, a1, 0, w0 << 16, bhvWarpPipe, ALL_ACTS), WARP_NODE(w0, 21, 2, w1, 0)
...
ZZ_WARP_PIPES(20, -820, -2317, -1575, 180, 21, 15545, -3957, -4210, 0),
ZZ_WARP_PIPES(22, 21340, -1951, 4650, -90, 23, 4520, -342, 6500, 90),
ZZ_WARP_PIPES(24, 4765, -342, 745, 90, 25, 21750, -1951, -1170, -90),
ZZ_WARP_PIPES(26, 10830, -3957, -850, 90, 27, -5045, -2317, 1080, -90),
ZZ_WARP_PIPES(28, -5340, 1474, -2550, -90, 29, 10280, -104, -4538, 90),
ZZ_WARP_PIPES(30, 15545, -3957, 2000, 0, 31, -830, -2317, 4700, 180),
OBJECT_WITH_ACTS(195,0x4000+-836,886,-3470,0,0,0,0x0, bhvBobombBuddyOpensCannon,31),
OBJECT_WITH_ACTS(201,0x4000+-842,-3964,-2173,0,0,0,0x0, bhvCannonClosed,31),
OBJECT_WITH_ACTS(122,0x4000+4201,-1408,5069,0,0,0,0x4000000, bhvStar,31),
OBJECT_WITH_ACTS(137,0x4000+-2192,-1354,-2176,0,0,0,0x30000, bhvExclamationBox,31),
OBJECT_WITH_ACTS(0,0x4000+2170,-1727,4140,0,0,0,0x0, bhvCoinFormation,31),
OBJECT_WITH_ACTS(180,0x4000+2094,-3731,2583,0,0,0,0x0, bhvFireSpitter,31),
OBJECT_WITH_ACTS(180,0x4000+1129,-2863,3098,0,0,0,0x0, bhvFireSpitter,31),
OBJECT_WITH_ACTS(180,0x4000+1708,-3152,3645,0,0,0,0x0, bhvFireSpitter,31),
OBJECT_WITH_ACTS(180,0x4000+2126,-2123,3194,0,0,0,0x0, bhvFireSpitter,31),
OBJECT_WITH_ACTS(0,0x4000+-3266,-4323,-1809,0,291,0,0x0, bhvFlamethrower,31),
OBJECT_WITH_ACTS(0,0x4000+-3096,-4427,-4155,0,90,0,0x0, bhvFlamethrower,31),
OBJECT_WITH_ACTS(0,0x4000+-2120,-4427,-4127,0,270,0,0x0, bhvFlamethrower,31),
OBJECT_WITH_ACTS(0,0x4000+-4143,-4479,-4103,0,180,0,0x0, bhvFlamethrower,31),
OBJECT_WITH_ACTS(0,0x4000+-4915,-4531,-2880,0,180,0,0x0, bhvFlamethrower,31),
OBJECT_WITH_ACTS(124,0x4000+-1229,-3948,-1733,0,148,0,0x400000, bhvMessagePanel,31),
OBJECT_WITH_ACTS(212,0x4000+-2006,-4318,-726,0,0,0,0x0, bhv1Up,31),
OBJECT_WITH_ACTS(194,0x4000+2675,-1654,236,0,0,0,0x0, bhvHomingAmp,31),
OBJECT_WITH_ACTS(194,0x4000+2231,-1563,267,0,0,0,0x0, bhvHomingAmp,31),
OBJECT_WITH_ACTS(194,0x4000+1912,-1458,-1850,0,0,0,0x0, bhvHomingAmp,31),
OBJECT_WITH_ACTS(180,0x4000+-2072,-52,-3671,0,0,0,0x0, bhvFireSpitter,31),
OBJECT_WITH_ACTS(180,0x4000+-2680,-52,-3671,0,0,0,0x0, bhvFireSpitter,31),
OBJECT_WITH_ACTS(180,0x4000+-2976,-52,-3703,0,0,0,0x0, bhvFireSpitter,31),
OBJECT_WITH_ACTS(180,0x4000+-2376,-52,-3671,0,0,0,0x0, bhvFireSpitter,31),
OBJECT_WITH_ACTS(0,0x4000+-3296,0,-3869,0,-270,0,0x0, bhvFlamethrower,31),
OBJECT_WITH_ACTS(0,0x4000+-1874,-52,-3846,0,-90,0,0x0, bhvFlamethrower,31),
OBJECT_WITH_ACTS(0,0x4000+-2952,677,-552,0,-180,0,0x0, bhvFlamethrower,31),
OBJECT_WITH_ACTS(0,0x4000+-3332,-4375,-2732,0,132,0,0x0, bhvFlamethrower,31),
OBJECT_WITH_ACTS(0,0x4000+-3264,-4479,-4970,0,0,0,0x0, bhvFlamethrower,31),
OBJECT_WITH_ACTS(0,0x4000+-4935,-4531,-3704,0,0,0,0x0, bhvFlamethrower,31),
OBJECT_WITH_ACTS(122,0x4000+-2613,-3281,-5545,0,0,0,0x5000000, bhvStar,31),
OBJECT_WITH_ACTS(215, 17538, -5000, 5200, 0, 0, 0, 0, bhvRedCoin, ALL_ACTS),
OBJECT_WITH_ACTS(215, 19730, -5000, 5100, 0, 0, 0, 0, bhvRedCoin, ALL_ACTS),
OBJECT_WITH_ACTS(215, 20150, -5000, 4650, 0, 0, 0, 0, bhvRedCoin, ALL_ACTS),
OBJECT_WITH_ACTS(215, 3700, 100, 6930, 0, 0, 0, 0, bhvRedCoin, ALL_ACTS),
OBJECT_WITH_ACTS(215, 18280, -2000, -1850, 0, 0, 0, 0, bhvRedCoin, ALL_ACTS),
OBJECT_WITH_ACTS(215, 18320, -2000, 150, 0, 0, 0, 0, bhvRedCoin, ALL_ACTS),
OBJECT_WITH_ACTS(215, 19930, -2000, -640, 0, 0, 0, 0, bhvRedCoin, ALL_ACTS),
OBJECT_WITH_ACTS(215, 14525, -4400, -3650, 0, 0, 0, 0, bhvRedCoin, ALL_ACTS),
OBJECT_WITH_ACTS(215, 12675, -4480, -3575, 0, 0, 0, 0, bhvRedCoin, ALL_ACTS),
OBJECT_WITH_ACTS(215, 10950, -4560, -4675, 0, 0, 0, 0, bhvRedCoin, ALL_ACTS),
OBJECT_WITH_ACTS(215, 12035, -4400, -2285, 0, 0, 0, 0, bhvRedCoin, ALL_ACTS),
OBJECT_WITH_ACTS(215, -6000, 400, 1525, 0, 0, 0, 0, bhvRedCoin, ALL_ACTS),
OBJECT_WITH_ACTS(215, -6565, 1000, 4375, 0, 0, 0, 0, bhvRedCoin, ALL_ACTS),
OBJECT_WITH_ACTS(215, 13790, 100, -440, 0, 0, 0, 0, bhvRedCoin, ALL_ACTS),
OBJECT_WITH_ACTS(215, 15545, -3950, -675, 0, 0, 0, 0, bhvRedCoin, ALL_ACTS),
OBJECT_WITH_ACTS(215, 15545, -3950, 575, 0, 0, 0, 0, bhvRedCoin, ALL_ACTS),
RETURN()
};
