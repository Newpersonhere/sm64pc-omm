...
if __name__ == "__main__":
    ...
    do_patch_file("behaviors/coin.inc.c", "bhv_coin_loop(void)", "cur_obj_update_floor_and_walls();", "bhv_coin_fix_step(o, 0);\n    ", -1)
    do_patch_file("behaviors/coin.inc.c", "bhv_coin_loop(void)", "cur_obj_move_standard(-62);", "\n    bhv_coin_fix_step(o, 1);", +1)
    do_patch_file("behaviors/moving_coin.inc.c", "coin_step(s16 *collisionFlagsPtr)", "*collisionFlagsPtr = object_step();", "bhv_coin_fix_step(o, 0);\n    ", -1)
